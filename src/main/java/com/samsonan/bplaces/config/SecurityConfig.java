    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers("/places/**/images/add").access("hasRole('ADMIN')")
                .antMatchers("/places/**/images/list").access("hasRole('ADMIN')")
                .antMatchers("/places/**/images/**/edit").access("hasRole('ADMIN')")
                .antMatchers("/places/**/images/**/delete").access("hasRole('ADMIN')")
